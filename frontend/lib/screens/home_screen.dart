    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (mounted && !_announced && !_isAnnouncing) {
        ...
        if (settings.voiceGuideEnabled) {
          ...
          final fullMessage = settings.languageCode == 'ur-PK'
          ...
          child: Column(
            ...
            children: [
              ...
              _buildHelpItem(
                ...
                title: 'Object Detection',
                description:
                    'Tap the Object Detection card to identify objects using your camera.',
              ),
              const SizedBox(height: 12),
              _buildHelpItem(
                icon: Icons.document_scanner,
                title: 'Text Reading',
                description:
                    'Tap the Text Reading card to scan and read text from images.',
              ),
              const SizedBox(height: 12),
              _buildHelpItem(
                icon: Icons.mic,
                ...
                description:
                    'Tap the microphone button in the bottom navigation to use voice commands.',
              ),
              const SizedBox(height: 12),
              _buildHelpItem(
                ...
                title: 'Voice Guide',
                description:
                    'Tap the speaker button (top right) to hear screen descriptions.',
              ),
              const SizedBox(height: 12),
              _buildHelpItem(
                icon: Icons.settings,
                title: 'Settings',
                description:
                    'Tap the settings icon (top right) to customize preferences.',
              ),
            ],
          ),
        ),
